...
IP6.ROUTE[1]:                           dst = fe80::/64, nh = ::, mt = 100`;
    ...
    test("key/value로 분리된 장치 정보에 대해 IDevAddres 정보로 얻어낸다.", () => {
      ...
      test("key/value로 분리된 장치 정보에 대해 IDevAddres6 정보로 얻어낸다.", () => {
        const inputRecord: Record<string, string> = {
          ...
          "IP4.DNS[1]": "8.8.8.8",
          "IP6.ADDRESS[1]": "fe80::7fb7:1e8f:34da:9c18/64",
          "IP6.ADDRESS[2]": "fd12:3456:789a::3/64",
          "IP6.GATEWAY": "--",
          "IP6.ROUTE[1]": "dst = fe80::/64, nh = ::, mt = 100",
        };
  ...
  test("NetworkInfo 리스트를 통해 장치의 IDevAddress 리스트를 얻어내야 한다.", async () => {
    ...
    const expectedStatForEth0 = `GENERAL.DEVICE:                         eth0
            GENERAL.TYPE:                           ethernet
            GENERAL.HWADDR:                         48:B0:2D:D8:BC:D2
            GENERAL.MTU:                            1500
            GENERAL.STATE:                          100 (connected)
            ...
            IP6.GATEWAY:                            --
            IP6.ROUTE[1]:                           dst = fe80::/64, nh = ::, mt = 100`;
    const expectedStatForDocker0 = `GENERAL.DEVICE:                         docker0
            GENERAL.TYPE:                           bridge
    ...
    (
      getDeviceStat as jest.MockedFunction<typeof getDeviceStat>
    ).mockImplementation((devName: string) => {
      if (devName === "eth0") {
